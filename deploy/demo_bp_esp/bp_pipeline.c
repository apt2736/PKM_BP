/**
 * @file bp_pipeline.c
 * @brief Implementation of End-to-End Blood Pressure Feature Extraction and SBP Regression Pipeline
 *
 * Dedicated SBP estimation using 23 Curated Physiological Biomarkers with Z-Score Normalization.
 */
